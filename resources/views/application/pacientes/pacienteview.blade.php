                          ...
                          <ul class="list-unstyled">
                              ...
                              <li>
                                  <div class="btn-group-vertical btn-block">
                                    <a href="{{ route('pacienteview') }}" class="btn btn-danger"><i class="fa fa-angle-double-right pull-left"></i>Datos Personales</a>
                              ...
                              <li>
                                  <div class="btn-group-vertical btn-block">
                                      <a href="{{ route('pacienteviewpagos') }}" class="btn btn-default"><i class="fa fa-chevron-right pull-right"></i>Recaudación(Pagos)</a>
