...
<html lang="en">
  <head>
    ...
    <!-- FullCalendar -->
    <link href="plugins/fullcalendar-3.4.0/fullcalendar.min.css" rel="stylesheet">
    <link href="plugins/fullcalendar-3.4.0/fullcalendar.print.css" rel="stylesheet" media="print">
  ...
  <body class="nav-md">
    ...
    <script src="plugins/fullcalendar-3.4.0/fullcalendar.min.js"></script>
    <script src='plugins/fullcalendar-3.4.0/locale-all.js'></script>
