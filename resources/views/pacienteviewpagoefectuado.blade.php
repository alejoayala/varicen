      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main" >
          ...
          <div class="header-content">
            <h2><i class="fa fa-home"></i> Pagos Efectuados <span>Alexander Ayala Suncion</span></h2>
                              ...
                              <ul class="list-unstyled">
                                  ...
                                  <li>
                                    <div class="btn-group-vertical btn-block">
                                        ...
                                        <a href="{{ route('pacienteviewpagoefectuado') }}" class="btn btn-danger"><i class="fa fa-chevron-right pull-right"></i>Pagos Recibidos</a>
