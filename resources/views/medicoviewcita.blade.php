                              ...
                              <ul class="list-unstyled">
                                  ...
                                  <li>
                                      <div class="btn-group-vertical btn-block">
                                        ...
                                        <a href="{{ route('medicoviewcita') }}" class="btn btn-danger"><i class="fa fa-chevron-right pull-right"></i>Citas Programadas</a>
                                     </div>
                                  </li>
                                  <li><br/></li>
                                  <li>
                          ...
                          <table class="table table-striped jambo_table bulk_action">
                            <thead>
                              <tr class="headings">
                                ...
                                <th class="column-title" width="30%">Hora Cita </th>
