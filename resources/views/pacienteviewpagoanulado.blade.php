      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main" >
          ...
          <div class="header-content">
            <h2><i class="fa fa-home"></i> Pagos Anulados <span>Alexander Ayala Suncion</span></h2>
                              ...
                              <ul class="list-unstyled">
                                  ...
                                  <li>
                                    <div class="btn-group-vertical btn-block">
                                        ...
                                        <a href="{{ route('pacienteviewpagoanulado') }}" class="btn btn-danger"><i class="fa fa-chevron-right pull-right"></i>Pagos Anulados</a>
                                    </div>
                                  </li>
                            ...
                            <div class="x_content">
                              <div class="page-title">
                                <div class="pull-right">
                                  <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#mymodal"><i class="fa fa-database"></i> Nuevo Anulación</button>
                                </div>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content bg-light">
                              <div class="modal-header alert-info pb-5">
                                ...
                                <h4 class="modal-title" id="myModalLabel">Registro de Devolución</h4>
                              </div>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group col-md-6">
                                              ...
                                              <select id="heard" class="form-control" required>
                                                ...
                                                <option value="press">NOTA DE CREDITO</option>
                                              </select>
                                            </div><!-- /.form-group -->
                                            <div class="form-group col-md-6">
