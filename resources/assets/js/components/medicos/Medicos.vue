                ...
                <table class="table table-striped jambo_table bulk_action">
                  ...
                  <tbody>
                    <tr class="even pointer">
                      ...
                      <td class=" last">
                        <a data-tooltip href="#" class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="top" data-original-title="Ver detalle"><i class="fa fa-eye"></i></a>
                        <a data-tooltip href="#" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" data-original-title="Editar"><i class="fa fa-pencil"></i></a>
                        <a data-tooltip href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top" data-original-title="Eliminar"><i class="fa fa-times"></i></a>
                      </td>
                    </tr>
                    ...
                    <tr class="even pointer">
                      ...
                      <td class=" ">996048894</td>
                      <td class=" last">
                        <router-link :to="{ path: '/detalle-medicos/datos'}" class="btn btn-success btn-xs"><i class="fa fa-eye"></i></router-link>
                        <a data-tooltip href="#" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" data-original-title="Editar"><i class="fa fa-pencil"></i></a>
                        <a data-tooltip href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top" data-original-title="Eliminar"><i class="fa fa-times"></i></a>
                      </td>
                    </tr>
